...
class Lawan_bos:
	def __init__(self, Layar, darah):
		...
		self.hitung_mundur = TMR.Timer(3, False,[self.pemain, self.pemain.info, self.bos], self.latar_belakang)
		self.item_jatuh = USEREVENT + 2
		self.musik_lawan_bos = SUARA.Suara('Aset\\Suara\\Musik\\lawan_bos.mp3', 'musik')
		self.ke = 0
